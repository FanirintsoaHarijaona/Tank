"""fichier qui spécifie les traits d'un agent""" 
import pygame                   
...
class Agent():
    ...
    def __init__(self, terrain, name, l_img_name, pos=(0,0), nb_rotates=1,
        ...
        #   self.l_img_mask[i] = masque de l'image self_id_img_mask en rotation de i*nb_rotates/360 °
        ...
        self.size = self.l_img_rotated[0][0].get_width() 
        self.half_size = int(self.size/2)         
        self.quart_size = int(self.size/4)        
        ...
        self.nb_bloc_neighb = int(self.bloc_size/self.terrain.bloc_size)+1
        self.bloc_delta = int((self.size-self.bloc_size)/2)  
